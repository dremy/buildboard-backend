...
# require_once 'sites/all/modules/contrib/fast_404/fast_404.inc';
...
# Static 404 page (see static_404 module).
# $conf['fast_404_HTML_error_page'] = dirname(__FILE__) . '/files/404/page_404.html';
...
# Disable poor mans cron
# $conf['cron_safe_threshold'] = 0;

# Fixes issue with SCALD not playing well with CKEditor in panel panes.
# https://www.drupal.org/node/2450879
# $conf['mee_store_format'] = 'embed_div';

# Leave page compression off.  No need with the stack we have.
# $conf['cache_lifetime'] = 0;
# $conf['page_compression'] = 0;

/*
 * Inherit the environmental settings file
 */
